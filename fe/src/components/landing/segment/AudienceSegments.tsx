    ...
    <div className="second-wrapper" id="segment">
      ...
      <div className="second-wrapper-top">
        ...
        <div className="second-subtext">
          Candling is re-imagining how support is delivered in the moments that
          matter most. It combines voice AI with empathetic design to bridge
          after-hours gaps and enable faster, smarter, and more humane responses
          across the entire care network.
      ...
      <div className="second-wrapper-bottom">
        <AudienceCard
          ...
          modalDescription={
            <>
              Even after hours, help is just a phone call away. Candling offers
              24/7 access to a compassionate, listening voice, trained on
              Singapore's care network. Callers don’t need to know what to ask
              for as our agent listens patiently, responds with care, and gently
              helps them find the support they need.
            </>
          }
        ...
        <AudienceCard
          ...
          modalTitle={
            <>
              For First Responder <br /> Teams
            </>
          }
          modalDescription={
            <>
              Candling flags high-risk calls based on escalation-trigger
              keywords, automatically alerting duty officers through warm
              transfers. Whether it's a police officer, social worker, or
              helpline responder, support teams receive concise summaries of
              what was said, how the caller felt, and what follow-up is needed.
            </>
          }
        ...
        <AudienceCard
          ...
          modalDescription={
            <>
              ...
              straight to the morning team’s dashboard. PSC counsellors can see
              which callers may need outreach, what services were discussed, and
              how distressed the caller sounded, all without breaching PDPA.
            </>
          }
