    ...
    <footer>
      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          {/* footer-logo */}
          <img className="footer-logo" src={candlingLogo} alt="Candling logo" />
        </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="code-block">
            ...
            <span className="code-line">
              This project was created by Isabelle and Brian,
            </span>
            {/* code-line */}
            <span className="code-line">
            ...
            <span className="code-line code-indent-2">
              ...
              <a
                ...
                target="_blank"
              >
                "https://www.linkedin.com/in/seet-isabelle/"{" "}
              </a>
              ,
            </span>
            {/* code-line code-indent-2 */}
            ...
            <span className="code-line code-indent-1">
              ...
              <a
                ...
                target="_blank"
              >
                "https://www.linkedin.com/in/brianchristianbc/"{" "}
              </a>
              ,
            </span>
            {/* code-line code-indent-2 */}
          ...
          <div className="feedback-container">
            ...
            >
              ...
              <img src={feedbackIcon} alt="call to action button" />
            </button>
            {/* feedback-code-block */}
