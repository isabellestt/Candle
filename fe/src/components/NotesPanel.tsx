              ...
              messages.map((message, index) => {
                ...
                return (
                  <div key={index} className={`bubble ${message.role}`}>
                    <strong>
                      {message.role === "user" ? "Caller" : "Candling"}
                    </strong>
                    <br />
                    {message.message}
                  </div>
          ...
          <div className="sidebar-call-details-row">
            ...
            <div className="detail-row">
              ...
              <span className="value">
                {record.details.structuredData.abuseType}
              </span>
            </div>
            <div className="detail-row">
            ...
            <div className="detail-row">
              ...
              <span className="value">
                {record.details.structuredData.transferred ? (
                  <span>TRUE</span>
                ) : (
                  <span>FALSE</span>
                )}
            ...
            <div className="detail-row">
              ...
              <span className="value">
                {record.details.structuredData.callerName}
              </span>
            </div>
            <div className="detail-row">
              <span className="label">CALLER LOCATION:</span>
              <span className="value">
                {record.details.structuredData.callerLocation}
              </span>
            </div>
            <div className="detail-row">
              <span className="label">LATEST INCIDENT:</span>
              <span className="value">
                {record.details.structuredData.latestIncident}
              </span>
            </div>
          </div>
          ...
          <div className="recommended-follow-up-section">
            ...
            <div className="sidebar-delete-log-button">
              <button onClick={() => handleDelete(record.id)}>
                <div className="sidebar-delete-log-button-text">
                  Delete Case
                </div>
